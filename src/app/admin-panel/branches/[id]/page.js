...
function Stores() {
    ...
    async (data) => {
      ...
      if (showFormItems.action == "created") {
        ...
        if (!data?.sizeID) {
          ...
          const results = sizes.map((_, index) => {
            return {
              ...data,
              sizeID: _?.id,
              size: _,
  ...
  console.log(watchStoreItems());
  console.log(watch());
  console.log(errors);
  console.log(errorsStoreItems);
  return (
      ...
      <div className="p-6 z-0">
        <div className="flex justify-between items-center">
          <div className="mb-4 font-bold text-5xl text-rose-700">
            <span>Quản trị kho hàng cơ sở ({branch?.name})</span>
      ...
      >
        <form className=" relative" onSubmit={handleSubmit(onSubmit)}>
          <div className="mt-2 col-span-4 flex flex-col">
                    ...
                    >
                      <div>
                        <h1 className=" font-roboto">
                          Tên sản phẩm:{" "}
                          <span className="font-dancing-script font-bold text-rose-700">
                            {_?.product?.name}
                          </span>
                        </h1>
                        <h1 className=" font-roboto">
            ...
            <p className="text-rose-700 indent-1 warn w-full mb-1 text-start text-sm font-roboto">

              ...
              if (_.roles.includes(role)) {
                return (
                  <Link key={i} href={_.href}>
                    <div className="p-3 w-full shadow-sm shadow-slate-400 rounded-md flex gap-3 items-center font-roboto hover:shadow-xl">
                      <div>
                        <span
                          className={`font-normal text-md text-gray-500 ${
                            pathname == _.href &&
                            `font-dancing-script font-bold text-rose-700 `
                          }`}
                        >
                          {_.title}
                        </span>

...
function ForgotPassword() {
  ...
  return (
    <div className="w-full h-screen flex font-dancing-script">
      <div className=" w-3/12 text-center text-slate-950 bg-white backdrop-blur-xl m-auto p-4 rounded-md relative ">
        <div className="pb-4 mt-6">
          ...
          {forgetPassState?.token ? (
            <>
              <h2 className="text-3xl">Đổi mật khấu</h2>
              <form onSubmit={handleSubmitChangePass(onSubmitChangePass)}>
                ...
                <div className="w-4/5 mx-auto mb-2 flex gap-2 items-center">
